...
The goal was to build a simple yet effective machine learning model and deploy it as an interactive web application so that anyone can use it in real time.
